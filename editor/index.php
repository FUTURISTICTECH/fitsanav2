...
<html lang="en">
<head>
	<title>FITSANA | Editor login</title>
	<meta charset="UTF-8">
...
<body> 
	...
	<?php 
	 ...
	 if(isset($_POST['submit'])){
		 ...
		 $select_user = mysqli_query($con, "select * from user_auth where email = '$email' and role = '$role' and password = '$password' ");
         if(mysqli_num_rows($select_user) == 1){
		   header("Location: home/home.php");
		   die;
		 }else{
			 echo "<div class='alert alert-primary'>Wrong credentials!</div>";
		 }
